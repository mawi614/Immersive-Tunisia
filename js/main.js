...
const MonumentDescriptionsEN = [
    ...
    //Beb Mnara Desc
    `It was built in 1276 AD on the western walls of the city during the Hafsid era and took the place of "Bab Arta", and Arta is the name of a military leader, who was said to have been killed on the spot where the door was built in the battles for the conquest of Tunis. It was also called Bab al-Manara after the lighthouse that was located between Bab al-Jadid and Kasbah Square. The city of Tunis closes its 6 doors at night, and only the Menara door remains open to receive people coming in late at night, and we find outside it a lantern that illuminates the people coming.`,
    //Beb Saadoun Desc
    ...
    //Beb Swika Desc
    `Bab Souika is located near the Helfaouine neighborhood, adjacent to Bab al-Asal and Bab al-Aqwas, between Bab al-Banat and Bab Cartagena from the inner walls, and between Bab al-Khadra and Bab Saadoun from the outer walls of the old city, and was demolished in 1861. It is currently one of the most important popular neighborhoods in Tunis, due to that door. The name Bab Souika is a diminutive form of the word souk, and there are accounts that say that a well was located in that area, and that watermen used to gather around it, taking water and walking around with it to water the trees and plants in the city.`
];
...
const MonumentDescriptionsFR = [
    ...
    //Beb Mnara Desc
    `Elle a été construite en 1276 sur les murs ouest de la ville à l'époque hafside et a pris la place de "Bab Arta". Arta est le nom d'un commandant militaire qui aurait été tué à l'endroit où la porte a été construite lors des batailles pour la conquête de Tunis. Elle était aussi appelée Bab al-Manara, du nom du phare qui se trouvait entre Bab al-Jadid et la place de la Kasbah. La ville de Tunis ferme ses 6 portes la nuit et seule la porte de la Ménara reste ouverte pour accueillir les gens qui entrent la nuit, et on trouve une lanterne à l'extérieur pour éclairer les gens qui entrent`,
    //Beb Saadoun Desc
    ...
    //Beb Swika Desc
    `Bab Souika est situé près du quartier de Helfaouine, à côté de Bab al-Asal et Bab al-Aqwas, entre Bab al-Banat et Bab Cartagena du côté de l'enceinte intérieure, et entre Bab al-Khadra et Bab Saadoun du côté de l'enceinte extérieure de la vieille ville, qui a été démolie en 1861. C'est actuellement l'un des quartiers populaires les plus importants de Tunis, qui porte le nom de cette porte. Le nom Bab Souika est un diminutif du mot souk, et des récits racontent qu'un puits se trouvait dans cette zone, autour duquel les bateliers se réunissaient et prenaient de l'eau pour arroser les arbres et les plantes de la ville.`
];
...
const MonumentDescriptionsAR = [
    ...
    `,
    //Beb Swika Desc
    `باب سويقة يقع قرب حي الحلفاوين المجاور لباب العسل وباب الاقواس، بين باب البنات وباب قرطاجنة من الأسوار الداخلية، وبين باب الخضراء وباب سعدون من الأسوار الخارجية للمدينة العتيقة، وكان قد هُدم عام
    1861 . وهو حاليًا أحد أهم الأحياء الشعبية للمدينة تونس نسبة إلى ذلك الباب. جاءت تسمية باب سويقة تصغير
    لكلمة سوق، وهناك روايات تقول إن بئرا كانت توجد في تلك المنطقة، وكان يجتمع حولها السقاؤون الذين
    يأخذون المياه ويتجولون بها لسقي الأشجار والنباتات في المدينة.`
];
...
/*--Goes to a monument--*/
function goToMonument(i){ 
    // Changing text to next    
    MonumentName.innerText = MonumentNames[i];
    MonumentText.innerText = MonumentDescriptions[i];
}
